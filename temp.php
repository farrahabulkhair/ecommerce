			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 sign-up" >
						<form name="signup-form" form action = "index.php" method = "POST" style = "margin-top: 60px;">
							<input class="signup-input" type="email" name="email_address" value="" placeholder="enter your email..." title="Please enter a valid email address." required><br>
							<input class="signup-input" type="password" name="password" value="" placeholder="enter your password..." title="Please enter your password" required><br>
							<input type="submit" name = "Login" value = "Login" class="submit-btn" style = "margin-top: 30px;"><br>

							<h2 style = "color: #848789; letter-spacing: 1px; font-size: 24px; font-weight: 300;">
						...
						<?php
							...
							if ($result[0]>0) {
								echo "Login successful! Return<a href = '../index.php'> home </a> .";
								}
